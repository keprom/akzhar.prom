		...
		<table width='735px' cellspacing='7px'>
			...
			<tr>
				<td width='588px'>
					...
					<?php 
					echo " ".$firm->dogovor." ".datetostring22($firm->dogovor_date); 
					?> 
					</p>
				</td>
				<td width='147px'>
			...
			<table width='500px' border=1px cellspacing=0 cellpadding=0>
				...
				<tr>
					...
					<p align=center>
					<?php
					if (strlen($schet2)==0){ echo ($schetfactura_date->id);} else {echo $schet2;}
					?> 
					</p>	
					</td>
					<td width='82px'>
					...
					if (strlen($data_schet)==0){ 
						echo datetostring22($schetfactura_date->date);
						} 
						else 
						{
							echo $data_schet; 
					...
					<p><?php
						echo datetostring22($period->begin_date);
						?></p>	
					</td>
					<td width='92px' align=center>
							<p><?php
						echo datetostring22($period->end_date);
						?></p>
					</td>
				</tr>
			</table>
...
?>	
	...
	?>
		...
		<th width='147px'>
			<p>
			<?php 
			echo f_d22($itog->itogo_with_nds);
			?>
			</p>
		</th>
	</tr>
