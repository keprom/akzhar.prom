 	...
 	<p><o:p> </o:p>
		<table border=1 cellspacing=0 cellpadding=0  width=30% align=right >
			...
			<tr>
				...
				<td align=center><?php  if (strlen($schet2)==0){ echo ($schetfactura_date->id);} else {echo $schet2;} ?></td>
				<td align=center><?php 
...
?>	
			...
			<tr>
				...
				<td align=center><?php echo f_d3($s2->tariff_value);?></td>
				<td align=center><?php 
			...
			<tr>
				<td>
					<table border=0 cellspacing=0 width=600px>
						<tr>
								...
								<td colspan=3>  <u><?php echo "И.о. директора ". trim($org->director);?></u> &nbsp;&nbsp;&nbsp;__________________</td></td></tr>
								<tr><td ></td>
								...
								<td>Отпустил </td>
								<td colspan=3><u><?php echo "Женатова С.И.  ";?></u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__________________ </td></tr><tr>
								<td></td>
				...
				<td> 
					<table width=600px>
						<tr>
							<td colspan=3>
								По доверенности № <?php echo $edit3."___  от ____   _________20___года"; ?>
							</td>
							...
							<td colspan=3> 
								Запасы получил ___________________ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_______________
							</td>
						</tr><tr>
							<td></td> 
							<td align=center>	
