...
echo "<b>Расчетный счет</b>: <input name=raschetnyy_schet value='".$r->raschetnyy_schet."' ><br><br>";
echo "<b>БИК фирмы</b>: <input name=bik value='".$r->bik."' ><br><br>";
echo "<b>Номер 1С</b>: <input name=nomer1c value='".$r->nomer1c."' ><br><br>";
